...
class AppConfig {
  ...
  // Radar
  static const double radarDisplayRadiusMeters =
      1000.0; // max distance shown on radar screen
  ...
  // GPS
  static const double defaultGpsAccuracyEstimate =
      10.0; // used when real accuracy is unknown
